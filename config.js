...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/d134b67d8e3b76a1c10ad.jpg?raw=true" ; // SET LOGO FOR IMAGE 
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "03112657705,03112657705";
...
module.exports = {
  ...
  menu: process.env.MENU || "", /**  Available @MENU @Schemes 1: Aztec_Md, 2: A17_Md, 3: Faisal-Md Default ---------- If Not Choose then it Randomely Pic One Of Them Each time **/

  HANDLERS: process.env.PREFIX  || ".",
  BRANCH  : process.env.BRANCH  || "main",
  VERSION : process.env.VERSION || "1.3.7",
  caption : global.caption || "" , // ```『 my name is Faisal udas love you all friend main kya help kar sakta hoon aapki』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAMe| "Faisal",
  ...
  LANG: ( process.env.THEME ||  "Muskan"  ).toUpperCase(),
...
// ========================= [ Disables in V.1.2.8 ] ===============================\\  
  ...
  //userImages:process.env.USER_IMAGES|| "https://telegra.ph/file/d134b67d8e3b76a1c10ad.jpg",  // SET IMAGE AND VIDEO URL FOR BOT MENUS 
